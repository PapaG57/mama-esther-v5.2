      ...
      <div className="custom-navbar-container">
        ...
        <Link to="/" className="navbar-brand-v2" onClick={() => setMenuOpen(false)}>
          <div className="logo-capsule-white">
            <div className="logo-combined-wrapper">
              {/* Le logo 3D qui s'insère dans l'espace que tu as créé */}
              <div className="navbar-logo-3d-container">
                {[...Array(6)].map((_, i) => (
                  <img
                    key={i}
                    src="/assets/logos/logoMama.png"
                    alt="Logo Icon"
                    className={`nav-logo-layer nav-layer-${i}`}
                  />
                ))}
              </div>

              {/* Ton nouveau logo-long.png avec l'espace blanc */}
              <img
            ...
            {/* Le cœur battant toujours fidèle au poste */}
