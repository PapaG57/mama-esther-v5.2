// HandSpinner.jsx - Version Culturelle & Moderne
...
export default function HandSpinner({ fullPage = false, text = "" }) {
  ...
  const SpinnerSVG = () => (
    <svg className="hand" viewBox="0 0 32 20">
      ...
      {/* Petit doigt (Pinky) */}
      <g className="hand__finger hand__finger--pinky" clipPath="url(#finger-pinky)">
      ...
      {/* Annulaire (Ring) */}
      <g className="hand__finger hand__finger--ring" clipPath="url(#finger-ring)">
        <g className="hand__finger-inner">
      ...
      {/* Majeur (Middle) */}
      <g className="hand__finger hand__finger--middle" clipPath="url(#finger-middle)">
        <g className="hand__finger-inner">
      ...
      {/* Index */}
      <g className="hand__finger hand__finger--index" clipPath="url(#finger-index)">
        <g className="hand__finger-inner">
      ...
      {/* Pouce (Thumb) */}
      <g className="hand__finger hand__finger--thumb" clipPath="url(#finger-thumb)">
        <g className="hand__finger-inner">
  ...
  if (!fullPage) return <SpinnerSVG />;

  return (
    <div className="hand-loader-overlay">
      <SpinnerSVG />
      <p className="hand-loader-text">{text || t("v2.loader.loading")}</p>
    </div>
  );
}
